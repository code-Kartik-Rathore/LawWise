    ...
    <Container maxWidth="sm" sx={{ mt: 4 }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <Paper elevation={3} sx={{ p: 4 }}>
          ...
          {summary && (
            <Box mt={4}>
              <Paper elevation={4} sx={{ p: 4, background: 'linear-gradient(135deg, #f0fdf4 60%, #e0f2fe 100%)', borderRadius: 3 }}>
                <Typography variant="h5" color="primary" sx={{ mb: 2, fontWeight: 700 }}>
                  Document Summary
                </Typography>
                <Typography variant="body1" sx={{ color: '#334155', fontSize: 18, lineHeight: 1.7, whiteSpace: 'pre-wrap' }}>
                  {summary}
                </Typography>
              </Paper>
            </Box>
